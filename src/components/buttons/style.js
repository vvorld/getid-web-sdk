...
const buttonStyles = makeStyles((theme) => ({
  root: {
    ...
    borderRadius: '83px',
    boxShadow: `0 4px 14px ${fade(theme.palette.blue.main, 0.5)}, inset 0 1px 2px ${fade(theme.palette.white, 0.45)}`,
  ...
  isGradient: {
    ...
    '&:disabled': {
      ...
      boxShadow: `0px 4px 14px ${theme.palette.blue.main}, inset 0px 1px 2px ${theme.palette.white}`,
      borderRadius: ' 83px',
      '&:hover': {
