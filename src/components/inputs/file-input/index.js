...
const Upload = () => (
  <svg className="icon" width="20" height="19" viewBox="0 0 20 19" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M16.125 8.25H17C18.1046 8.25 19 9.14543 19 10.25V16.25C19 17.3546 18.1046 18.25 17 18.25H3C1.89543 18.25 1 17.3546 1 16.25V8.25C1 7.14543 1.89543 6.25 3 6.25H4.31431C4.98394 6.25 5.60915 6.58513 5.97986 7.14278L6.12241 7.35722C6.49313 7.91487 7.11833 8.25 7.78797 8.25H8.875" strokeWidth="1.5" strokeLinecap="round" />
    <line x1="12.5" y1="11.5" x2="12.5" y2="2.5" strokeWidth="1.5" strokeLinecap="round" />
    <path d="M15.181 4.18198L12.4995 1.50049L9.81802 4.18198" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);
